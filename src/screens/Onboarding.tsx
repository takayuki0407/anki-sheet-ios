...
const SLIDES = [
  ...
  },
  {
    emoji: "👆",
    title: "隠す・めくる・拡大",
    body: "答えをタップで表示／もう一度タップで再び隠す。隠し方は『赤マスク』と『赤シート』から選べます。2本指ピンチで拡大、倍率をタップで100%。縦読み・横読み・目次（しおり）・★復習にも対応。",
  },
  {
    emoji: "🎯",
    title: "自動検出＋微調整",
  ...
  {
    emoji: "🤖",
    title: "AIで○×問題（解いて確かめる）",
    body: "本の「問題」から、ページの本文と隠す語句をもとにAIが○×問題を自動生成。覚えたつもりを解いて確認できます。生成時のみ本文と語句をサーバー経由でAIに送信します（初回に同意確認）。プラン別に月間の生成枠があります。",
  },
  {
    emoji: "🎁",
    title: "まずは無料で",
    body: "サインインだけで Free（本1冊・AI 月1ページ）として使えます。トライアル後もロックされません。もっと使うなら Standard（本10冊）／ Pro（無制限・全端末でクラウド同期）。いつでも解約できます。",
  },
];
