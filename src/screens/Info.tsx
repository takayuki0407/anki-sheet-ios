      ...
      >
        <Section title="使い方">
          ...
          <Help
            ...
            a="Pro/Premium で取り込んだ本は PDF・検出結果・進捗（★・しおり・読書位置）がクラウドに保存され、別の端末からも取り込み直せます。Standard/Free に下げると上限を超えた本はクラウドに退避し（約6ヶ月保持）、再び Pro/Premium にすると復元できます。本棚の各本の「☁️ クラウドあり／端末のみ」表示で、削除しても後で戻せるか分かります（「端末のみ」は削除すると復元できません）。"
          />
        </Section>
