    ...
    <View style={styles.c}>
      ...
      <ScrollView contentContainerStyle={styles.pad}>
        <Section title="使い方">
          <Help
            q="赤シート暗記とは？"
            a="色付きの答え（赤やマゼンタ）が印刷されたPDFを取り込むと、その答えを自動で検出してマスクし、デジタル赤シートとして隠しながら暗記できます。PDFは端末内だけで処理され、どこにもアップロードされません。"
          />
          <Help
            q="PDFの取り込み方"
          ...
          <Help
            q="ビューアの操作"
            a="答えをタップで表示／もう一度タップで再び隠す。『赤シート』ボタンで一括ON/OFF。2本指のピンチで拡大・縮小、倍率の数字をタップで100%に戻す。『幅／全体』で表示の合わせ方、『縦読み／横読み』で読み方、『目次』でしおりの追加・移動ができます。"
          />
        </Section>
