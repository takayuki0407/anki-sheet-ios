    ...
    <View style={styles.c}>
      ...
      >
        <Section title="使い方">
          ...
          <Help
            q="プランについて"
            a="サインインだけで使える Free（本1冊・AI生成 月1回）／Standard ¥300（本10冊・AI 月10回）／Pro ¥600（本 無制限・AI 月30回・全端末でクラウド同期）／Premium ¥980（Proの全機能・AI 月200回・「今日の復習」で間違えやすい問題を最適なタイミングに再出題。初回7日間無料）。AI生成は「1回＝1ページ×問題の種類」で数えます。本の冊数はアカウント全体（すべての端末の合計）で数えます。未契約でもロックされず Free として使えます。現在のプラン・AI残り枠は下の「プラン」欄で確認できます。"
          />
          <Help
